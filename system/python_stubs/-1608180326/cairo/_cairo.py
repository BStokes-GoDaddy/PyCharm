...
# from /usr/lib/python3/dist-packages/cairo/_cairo.cpython-34m-x86_64-linux-gnu.so
# by generator 1.138
# no doc
...
class PDFSurface(__cairo.Surface):
    # no doc
    def pdf_version_to_string(self, *args, **kwargs): # real signature unknown
        pass
...
class SVGSurface(__cairo.Surface):
    ...
    def svg_version_to_string(self, *args, **kwargs): # real signature unknown
        pass
